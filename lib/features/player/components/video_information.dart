...
// membuat stateful widget VideoInformation
...
class _VideoInformationState extends State<VideoInformation> {
  bool _canShowMore = true; // untuk handle show more atau show less

  switchShowMore() {
    setState(() {
      _canShowMore = !_canShowMore; // mengubah nilai _canShowMore dan merender ulang widget
    });
  }

  bool _hasMoreThanThreeLine(String? deskripsi) {
    // untuk mengecek apakah deskripsi lebih dari 3 baris
    final span = TextSpan(
      text: deskripsi,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if (_hasMoreThanThreeLine(widget.video.description) && // menampilkan widget sesuai kondisi
            _canShowMore) ...[
          Text(
