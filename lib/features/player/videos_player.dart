...
// membuat stateful widget VideosPlayer
...
class VideosPlayerState extends State<VideosPlayer> {
  late Video video; // untuk menampung state video
  ...
  @override
  void didChangeDependencies() { // untuk membuat data dinamis dengan mengambil data dari arguments
  ...
  void initVideoController() { // untuk menginisialisasi video controller
